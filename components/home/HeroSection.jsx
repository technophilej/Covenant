    ...
    <section className="relative min-h-[88vh] flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover object-[72%_center] sm:object-[64%_center] md:object-center brightness-[0.6]"
        />
        <div className="absolute inset-0 bg-gradient-to-b md:bg-gradient-to-r from-brand-navy/86 via-brand-navy/60 to-brand-navy/38 md:from-brand-navy/92 md:via-brand-navy/78 md:to-brand-navy/55" />
      </div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
        <div className="max-w-[22rem] sm:max-w-xl md:max-w-2xl p-0">
          <h1
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-14">
            <Link
              href="/request-care"
              className="inline-flex items-center justify-center gap-2 bg-brand-green-700 hover:bg-brand-green-800 text-white px-8 py-4 rounded-full font-semibold text-sm transition-all duration-200 shadow-lg group"
            >
